...
# ═══════════════════════════════════════════════════════════════════
# NMAP STEALTH SCAN - ONE LINE CHANGE
...
OUTPUT_FILE="$OUTPUT_DIR/stealth_scan_${TARGET//[.:\/]/_}_$(date +%Y%m%d_%H%M%S)"

echo "════════════════════════════════════════════════════════"
echo "  NMAP STEALTH SCAN (SYN)"
echo "  Target: $TARGET"
echo "  Using stealthy techniques..."
echo "════════════════════════════════════════════════════════"
